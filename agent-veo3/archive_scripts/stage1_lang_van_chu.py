...
PROMPT_0 = (
    ...
    "STRICTLY ZERO shiny white porcelain mask, ZERO chalky white enamel face contrast.\n"
    ...
    "COSTUME: Silvery moon-grey silk daoist martial robe over a crisp frost-white inner robe with diagonal collar wrap, "
    "delicate ink-black cloud embroidery along lapels and sleeve cuffs. "
    "Broad structured black-and-silver waist belt with a centered white jade square plaque, wrapping tightly and flatly around the waist. "
...
async def main():
    print("Starting Stage 1 (0° Strict Frontal) for Ling Yunchu...", flush=True)
